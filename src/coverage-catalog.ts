...
const COVERAGE_SPECS: SpecTuple[] = [
  ...
  ['outreach', 'Outreach', 'crm', 'sales', 'tier_1', 'sales-engagement,sequences,crm'],
  ['salesloft', 'Salesloft', 'crm', 'sales', 'tier_1', 'sales-engagement,cadences,crm'],
  ['zoominfo', 'ZoomInfo', 'crm', 'sales', 'tier_1', 'sales-intelligence,enrichment,gtm'],
  ['demandbase', 'Demandbase', 'crm', 'sales', 'tier_1', 'account-intelligence,abm,gtm'],
  ...
  ['aws-lambda', 'AWS Lambda', 'workflow', 'dev', 'tier_1', 'aws,serverless,dev', 'api_key'],
  ['aws-cloudwatch', 'AWS CloudWatch', 'database', 'analytics', 'tier_1', 'aws,logs,observability', 'api_key'],
  ...
  ['cloudflare', 'Cloudflare', 'workflow', 'dev', 'tier_1', 'edge,dev,dns', 'api_key'],
  ...
  ['adp', 'ADP', 'workflow', 'hr', 'tier_1', 'hr,payroll,workforce'],
  ['paychex', 'Paychex', 'workflow', 'hr', 'tier_1', 'hr,payroll,workforce'],
  ['docusign', 'DocuSign', 'docs', 'docs', 'tier_1', 'contracts,signature,legal'],
  ['adobe-sign', 'Adobe Acrobat Sign', 'docs', 'docs', 'tier_1', 'contracts,signature,legal'],
  ...
  ['nango', 'Nango', 'workflow', 'workflow', 'tier_1', 'integration-platform,gateway', 'custom'],
