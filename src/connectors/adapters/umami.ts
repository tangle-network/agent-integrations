...
export const umamiConnector = declarativeRestConnector({
  ...
  capabilities: [
    ...
    },
    {
      ...
      class: 'mutation',
      description: 'Create a new tracked website.',
      parameters: {
        type: 'object',
        properties: {
          name: { type: 'string', description: 'Display name of the website.' },
          domain: { type: 'string', description: 'Primary domain (e.g., example.com).' },
          shareId: { type: 'string', description: 'Optional public share token.' },
          teamId: { type: 'string', description: 'Team owning the website.' },
        },
    ...
    },
    {
      ...
      class: 'mutation',
      description: 'Update settings on an existing website.',
      parameters: {
        type: 'object',
        properties: {
          websiteId: { type: 'string', description: 'The website ID.' },
    ...
    },
    {
      ...
      class: 'mutation',
      description: 'Delete a tracked website and its analytics data.',
      parameters: {
        type: 'object',
        properties: { websiteId: { type: 'string', description: 'The website ID.' } },
        required: ['websiteId'],
