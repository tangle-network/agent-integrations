...
export const timeOpsConnector = declarativeRestConnector({
  ...
  capabilities: [
    ...
    },
    {
      ...
      request: { method: 'PATCH', path: '/customers/{id}', body: 'args' },
      cas: 'native-idempotency',
      externalEffect: true,
    },
    {
    ...
    },
    {
      ...
      request: { method: 'PATCH', path: '/registrations/{id}', body: 'args' },
      cas: 'native-idempotency',
      externalEffect: true,
    },
    {
      ...
      class: 'mutation',
      description: 'Delete a time registration.',
      parameters: {
        type: 'object',
        properties: {
          id: { type: 'string' },
      ...
      request: { method: 'DELETE', path: '/registrations/{id}' },
      cas: 'native-idempotency',
      externalEffect: true,
    },
    {
