...
export const productboardConnector = declarativeRestConnector({
  ...
  capabilities: [
    ...
    },
    {
      ...
      request: { method: 'DELETE', path: '/features/{featureId}' },
      cas: 'native-idempotency',
      externalEffect: true,
    },
    {
      name: 'notes.update',
      class: 'mutation',
      description: 'Update a customer feedback note.',
      parameters: {
        type: 'object',
        properties: {
          noteId: { type: 'string' },
      ...
      request: { method: 'PATCH', path: '/notes/{noteId}', body: 'args' },
      cas: 'native-idempotency',
      externalEffect: true,
    },
    {
      name: 'notes.delete',
      class: 'mutation',
      description: 'Delete a customer feedback note.',
      parameters: {
        type: 'object',
        properties: { noteId: { type: 'string' } },
        required: ['noteId'],
      },
      request: { method: 'DELETE', path: '/notes/{noteId}' },
      cas: 'native-idempotency',
      externalEffect: true,
    },
    {
      ...
      class: 'mutation',
      description: 'Create a new component grouping.',
      parameters: {
        type: 'object',
        properties: {
          name: { type: 'string' },
          description: { type: 'string' },
          parentId: { type: 'string', description: 'Optional parent component or product ID.' },
        },
        required: ['name'],
      },
      request: { method: 'POST', path: '/components', body: 'args' },
      cas: 'native-idempotency',
      externalEffect: true,
    },
  ],
