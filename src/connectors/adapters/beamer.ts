...
export const beamerConnector = declarativeRestConnector({
  ...
  capabilities: [
    ...
    },
    {
      ...
      class: 'mutation',
      description:
        'Edit a published announcement post. Pass only the fields you wish to change; omitted fields are left untouched.',
      parameters: {
        type: 'object',
        properties: {
    ...
    },
    {
      name: 'posts.delete',
      class: 'mutation',
      description: 'Delete an announcement post.',
      parameters: {
        type: 'object',
        properties: {
    ...
    },
    {
      ...
      class: 'mutation',
      description: 'Delete a comment on a feature request.',
      parameters: {
        type: 'object',
        properties: {
          featureRequestId: { type: 'string', description: 'Id of the feature request.' },
          commentId: { type: 'string', description: 'Id of the comment to delete.' },
        },
        required: ['featureRequestId', 'commentId'],
      },
      request: {
        method: 'DELETE',
        path: '/feature-requests/{featureRequestId}/comments/{commentId}',
      },
      cas: 'native-idempotency',
      externalEffect: true,
    },
    {
      name: 'featureRequests.update',
      class: 'mutation',
      description:
        'Update an existing feature request (title, content, category, status). Pass only the fields you wish to change.',
      parameters: {
        type: 'object',
        properties: {
          featureRequestId: { type: 'string', description: 'Id of the feature request to update.' },
          title: { type: 'string' },
          content: { type: 'string' },
          category: { type: 'string' },
          status: { type: 'string' },
