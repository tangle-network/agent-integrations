...
| Native adapter surfaces shipped | 632 |
...
...and 552 more native adapter surfaces.
...
| Native adapter execution | Done for listed native backends | 632 reviewed native adapter surfaces ship from this package; 516 overlap the 669 catalog contracts. |
...
5. **Native adapter coverage is intentionally smaller than contract breadth.**
   This repo ships 632 native adapter surfaces. 516 overlap the 669 catalog contracts; the remaining catalog contracts are not product-executable until ported.
